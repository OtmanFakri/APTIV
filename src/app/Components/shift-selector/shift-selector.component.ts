...
export class ShiftSelectorComponent {
    @Input() value: ShiftEnum | null = null;
    ...
    ngOnChanges(changes: SimpleChanges) {
        if (changes['value'] && this.value) {
            this.selectedShift = Object.keys(ShiftEnum).find(key => ShiftEnum[key as keyof typeof ShiftEnum] === this.value) as keyof typeof ShiftEnum || null;
        }
    }
