...
export class ExaminitationService {
    ...
    GetConsulation(): Observable<ExaminitionRespence> {
        return this.http.get<ExaminitionRespence>(`${this.apiUrl}/consultation/`)
    }
    ...
    PostEmployeeExamination(id_Examination: number, id_Employee: number,description:string): Observable<any> {
